...
# Efecto-de-la-Inversi-n-en-Publicidad-Digital-sobre-las-Ventas
Modelo de regresión múltiple con transformación adstock e interacciones para evaluar si la inflación modera el impacto de Google Ads, Facebook y TikTok sobre las ventas. Incluye descomposición de ventas por canal, análisis de ROI y dashboard interactivo en Shiny. Datos: 200 semanas (2018–2021), R² = 91.3%.
